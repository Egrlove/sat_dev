...
void visualize(int num_time, int Yrange) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  char string[80];
  // int fds = open("result.txt", O_CREAT | O_WRONLY);
  FILE *fds = fopen("result.txt", "w");
